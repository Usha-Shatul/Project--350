document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (currentUser?.id || currentUser?.userId) {
        ...
        currentUserId = uid;
        try {
            const resp = await fetch(`${API_BASE_URL}/roles/${uid}`);
        ...
        if (!currentUser?.name || !currentUser?.username) {
            try {
                const profResp = await fetch(`${API_BASE_URL}/profile/${uid}`);
                if (profResp.ok) {
    ...
    createDropdownBtn.style.display = 'inline-flex';
    ...
    async function loadNotices(page = 1) {
        ...
        try {
            const resp = await fetch(`${API_BASE_URL}/society-notices?page=${page}&limit=20`);
            if (!resp.ok) {
                ...
                for (const n of items) {
                    ...
                    if (isOwner) {
                        ...
                        btn.addEventListener('click', async (e) => {
                            ...
                            try {
                                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/society-notices/${id}`, { method: 'DELETE' });
    ...
    async function loadEvents(page = 1) {
        ...
        try {
            const resp = await fetch(`${API_BASE_URL}/events?page=${page}&limit=20`);
                if (!resp.ok) {
                ...
                for (const event of items) {
                    ...
                    if (isCreator || isCommittee) {
                        ...
                        deleteBtn.addEventListener('click', async (e) => {
                            ...
                            try {
                                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/events/${id}`, { method: 'DELETE' });
                                const del = await resp.json();
    ...
    async function loadNoticeDetails(noticeId) {
        try {
            const resp = await fetch(`${API_BASE_URL}/society-notices/${noticeId}`);
            const json = await resp.json();
    ...
    async function loadEventUpdates(eventId) {
        try {
            const resp = await fetch(`${API_BASE_URL}/events/${eventId}/updates`);
            const json = await resp.json();
    ...
    if (noticeForm) {
        ...
        try {
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/society-notices`, {
                method: 'POST',
    ...
    if (eventForm) {
        ...
        try {
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/events`, {
                method: 'POST',
    ...
    if (addUpdateForm) {
        ...
        try {
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/events/${currentEventId}/updates`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async function loadBatchOptions() {
        ...
        try {
            ...
            const response = await window.authManager.authenticatedFetch(`${API_BASE_URL}/groups/batch-options`);
    ...
    if (meetingRoomForm) {
        ...
        try {
            const response = await window.authManager.authenticatedFetch(`${API_BASE_URL}/groups/meeting-rooms`, {
                method: 'POST',
    ...
    async function loadDiscussions() {
        ...
        try {
            ...
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/groups/discussions`);
                    ...
                    discussions.forEach(discussion => {
                        ...
                        if (!isDefault) {
                            ...
                            deleteBtn.addEventListener('click', async (e) => {
                                ...
                                try {
                                    const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/groups/${id}`, { method: 'DELETE' });
                                    const del = await resp.json();
    ...
    if (manageOverlay) manageOverlay.addEventListener('click', closeManageModal);
     ...
     if (createRegistrationForm) {
         createRegistrationForm.addEventListener('submit', async (e) => {
             ...
             try {
                 const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/registrations`, {
                     method: 'POST',
     ...
     if (editRegistrationForm) {
         editRegistrationForm.addEventListener('submit', async (e) => {
             ...
             try {
                 const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/registrations/${regId}`, {
                     method: 'PUT',
                     body: JSON.stringify(data)
                 });
                 const json = await resp.json();
     ...
     if (editFeeForm) {
         editFeeForm.addEventListener('submit', async (e) => {
             ...
             try {
                 const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees/${feeId}`, {
                     method: 'PUT',
                     body: JSON.stringify(data)
                 });
                 const json = await resp.json();
    ...
    if (createFeeForm) {
        createFeeForm.addEventListener('submit', async (e) => {
            ...
            try {
                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees`, {
                    method: 'POST',
                    body: JSON.stringify(data)
                });
                const json = await resp.json();
    ...
    if (paymentForm) {
        paymentForm.addEventListener('submit', async (e) => {
            ...
            try {
                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees/pay`, {
                    method: 'POST',
                    body: JSON.stringify(data)
                });
                const json = await resp.json();
                ...
                if (items.length === 0) {
                    ...
                    document.querySelectorAll('.register-free-btn').forEach(btn => {
                        btn.addEventListener('click', async () => {
                            ...
                            try {
                                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/registrations/${btn.dataset.id}/register`, { method: 'POST' });
                                if (resp.ok) {
                    ...
                    document.querySelectorAll('.close-reg-btn').forEach(btn => {
                        btn.addEventListener('click', async () => {
                            ...
                            try {
                                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/registrations/${btn.dataset.id}/close`, { method: 'POST' });
                                if (resp.ok) {
                ...
                if (items.length === 0) {
                    ...
                    document.querySelectorAll('.close-fee-btn').forEach(btn => {
                        btn.addEventListener('click', async () => {
                            ...
                            try {
                                const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees/${btn.dataset.id}/close`, { method: 'POST' });
                                if (resp.ok) {
    ...
    async function manageRegistration(id, type, title) {
        ...
        try {
            let endpoint = type === 'free' ? `${API_BASE_URL}/registrations/${id}/participants` : `${API_BASE_URL}/registrations/${id}/payments`;
    ...
    async function manageFee(id, title) {
        ...
        try {
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees/${id}/payments`);
            const json = await resp.json();
            if (resp.ok && json.success) {
    ...
    async function updateStatus(id, status, btn) {
        ...
        try {
            const resp = await window.authManager.authenticatedFetch(`${API_BASE_URL}/fees/transactions/${id}/status`, {
                method: 'PUT',
         ...
         editBtn.addEventListener('click', async () => {
             ...
             try {
                 let endpoint = ctx.type === 'registration'
                     ? `${API_BASE_URL}/registrations/${ctx.id}`
                     : `${API_BASE_URL}/fees/${ctx.id}`;
    ...
    if (finishBtn) {
        finishBtn.addEventListener('click', async () => {
            ...
            try {
                let endpoint = ctx.type === 'registration'
                    ? `${API_BASE_URL}/registrations/${ctx.id}/close`
                    : `${API_BASE_URL}/fees/${ctx.id}/close`;
    ...
    approvalManager = new ApprovalManager(API_BASE_URL);
