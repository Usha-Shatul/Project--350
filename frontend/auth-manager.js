// // JWT Authentication utilities for Swe_Society
// class AuthManager {
//     constructor() {
//         this.TOKEN_KEY = 'Swe_Society_token';
//         this.USER_KEY = 'Swe_Society_user';
...
class AuthManager {
    constructor() {
        this.TOKEN_KEY = 'Swe_Society_token';
        this.USER_KEY = 'Swe_Society_user';
        this.API_BASE_URL =  'http://localhost:5500/api';
    }
    ...
    async authenticatedFetch(url, options = {}) {
        ...
        try {
            ...
            // ✅ FIXED: Clone before reading body so callers can still read it
            if (response.status === 401) {
